...
const protectionOptionsList: Record<EMachineTypeAlias, EMachineProtectionType[]> = {
...
export const EMachineElement: SystemElement<EMachine> = {
  ...
  customize: (model, value) => {
    ...
    const protectionOptions = protectionOptionsList[value.type] || [...EMachineProtection];
    updatedModel = {
      ...updatedModel,
      params: {
        ...updatedModel.params,
        protection: {
          ...
          value: protectionOptions.includes(value.protection) ? value.protection : protectionOptions[0] || "IP21/23",
        },
      },
    };
