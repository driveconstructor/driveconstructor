...
Extra question: you've got MV motor with accessible termnical box which can be
...
There is avaiable a cubicle where the FC can be potentially placed. At the
