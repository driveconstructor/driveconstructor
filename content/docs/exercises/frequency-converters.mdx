...
Design drive trains for the six different conveyors. Each conveyor is to be driven by one motor.
System topology is the same for all the conveyors: gearbox _1:5_ (type: helical). Grid voltage is 400 V.
...
#### Request 2: Oil pump (inflamable oil)
* Parameters:
...
*Fig.1.Belt conveyor at a cement plant.* (<Link href="https://www.vecteezy.com/free-photos/turbine">picture source</Link>)
