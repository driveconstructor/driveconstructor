...
![Conveyor in narrow passage](./images/C1.png) _Fig.1. Explanation for the task._
...
![Conveyor with two drums system layout](./images/C5.png) _Fig.1. Explanation of the task._
