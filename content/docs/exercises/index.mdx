...
![DriveConstructor main page](./images/userman1.png)
...
![Menu navigation tip](./images/userman1a.png)
...
![Drive train with variable speed drive setup](./images/userman2.png)
...
![Component selection with checkboxes](./images/userman3.png)
...
![Drive train with voltage step down](./images/userman4.png)
...
![Transformer voltage configuration](./images/userman5.png)
...
![Transformer and frequency converter compatibility](./images/userman6.png)
...
![System report parameters](./images/userman15.png)
...
![Save system button](./images/userman7.png)
...
![System name dialog](./images/userman8.png)

##### STEP 3. Open "My systems"

Here you can see key parameters of the saved system:

![My systems overview](./images/userman9.png)
...
![DriveConstructor navigation](./images/userman10.png)
...
![System topology selection](./images/userman11.png)
...
![System comparison selection](./images/userman12.png)

Then the graph appear as below:

![System comparison graph](./images/userman13.png)

Use feedback form for any comments, proposals and reporting problems to the
course developers

![Feedback form](./images/userman14.png)
