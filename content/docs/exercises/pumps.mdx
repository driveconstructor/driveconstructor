...
types. Make conclusion how CT/QT and BT value affects the choice.
...
Load profile is given (table below). What is system efficiency at each load? How much energy consumed per year? 
What is the cost of energy per year if 1 kWh costs 0.2 Euro. 
What is the cost of the system consisting of motor, cable and frequency converter?
