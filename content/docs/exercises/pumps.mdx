...
![Drive system for pump exercises](./images/pmp_fc_EM3_2.png)
...
![Variants of placing the equipment](./images/P5_1.png) _Variants of placing the
equipment._
...
![Sketch of the landscape](./images/P6_1.png) _Sketch of the landscape._
