...
2. _head_ 200 m, _flow_ 145 l/s, _efficiency_ 85%, rated speed 2950 rpm;
3. _head_ 200 m, _flow_ 200 l/s, _efficiency_ 85%, rated speed 2950 rpm.
...
have insulstion class _"B"_)? If we use smaller machine with the same class
