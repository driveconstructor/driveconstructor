...
Draw conclusions on efficiency vs cost. First take only induction machine and
try different efficiency classes. Then try PM machine. Summarize the design
results (system efficiency and cost) in a table.

Finally, design the system for highest efficiency. Limit system cost to 30000
Euro.
