...
![Drive system for pump with efficiency analysis](./images/pmp_fc_EM3_2.png)
...
![THD limits table according to IEEE519](./images/SYS_3_table.png)

## SYS-4. System design

Choose optimal drive train for a pump in water supply system.

![Centrifugal pump system](./images/SYS4.png)
...
![Spider diagram benchmarking example](./images/Spider.png)
...
![Gearbox with 2 planetary stages and one helical stage](./images/SYS5_wind_gear.png) _Fig.1. Gearbox with 2 planetary stages and one helical stage - "Pl+Pl+Hel" (Source: Romax)._
...
Compare the following three variants of gearbox stages and electric machines:
(1) _Worm+SCIM_ vs (2) _Hel+Hel+SCIM_ vs (3) _Hel+Bevel+SCIM_, where "Worm"
means worm gearbox.

![Gearbox with 1 worm stage](./images/SYS5_worm.png) _Fig.2. Gearbox with 1 worm stage - "Worm"._
...
![Drive train comparison table](./images/SYS5table.png)
...
![Cable length and losses comparison table](./images/sys6table.png)
