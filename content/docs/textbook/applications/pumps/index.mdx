...
<img src={dcImage.src} alt="Centrifugal pump" width="25%" height="25%" />
...
<img src={pcpImage.src} alt="Progressing cavity pump" width="40%" height="40%" />
...
See also:
    ...
    - [Pump types & load curves](/docs/applications/pumps)
    - [Parameters of pumps](/docs/applications/pumps)
