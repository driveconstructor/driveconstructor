...
There are two basic types of pumps: positive displacement and centrifugal (rotodynamic). Load curves (torque-speed characteristics) of these two types of pumps are different:
    ...
    - Positive displacement pumps have constant load (CT) curve $$T∼const$$ (Fig.3)

import pmpcQTImage from "./images/pump-curve-QT.png";

<img src={pmpcQTImage.src} alt="pump-curve-QT" width="40%" height="40%" /> *Fig.2. QT curve.*

import pmpcCTImage from "./images/pump-curve-CT.png";

<img src={pmpcCTImage.src} alt="pump-curve-CT" width="40%" height="40%" /> *Fig.3. CT curve.*
...
<img src={pmpcCSImage.src} alt="pump-curves-stiction" width="50%" height="50%" />
*Fig.3. Pump with QT load curve and starting curve.*

In *DriveConstructor* starting torque is defined as the fraction of rated torque $$T_r$$. The following values can be chosen: 0.0, 0.1, 0.2, 0.3, ..., 1.8, 1.9, 2.
