...
![doc-pump-and-resistance-curve](./images/pump-and-resistance-curve.png)
...
![doc-pump-curves-ct-bt](./images/pump-curves-CT-BT.png) _Fig.2. Pump with CT
load curve and starting curve._

![doc-pump-curves-stiction](./images/pump-curves-stiction.png) _Fig.3. Pump with
QT load curve and starting curve._
