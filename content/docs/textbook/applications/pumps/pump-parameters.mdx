...
![Pump curves CT-BT](./images/pump-curves-CT-BT.png) _Fig.2. Pump with CT load
curve and starting curve._

![Pump curves stiction](./images/pump-curves-stiction.png) _Fig.3. Pump with QT
load curve and starting curve._
