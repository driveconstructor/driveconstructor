...
![Pumps classification](./images/pumps-classification.png) _Fig.1. Pump
classification._
...
![Pump curve QT](./images/pump-curve-QT.png) _Fig.2. QT curve._

![Pump curve CT](./images/pump-curve-CT.png) _Fig.3. CT curve._
