...
![Wind turbine 1](./images/wind-turbine-1.png) _Fig.1. Wind turbine with a
gearbox and a generator._
...
![WT nacelle](./images/wt-nacelle.png) _Fig.2. Equipment in the nacelle._

![Tidal turbine 1](./images/tidal-turbine-1.png) _Fig.3. Tidal turbine._
...
![WT generator torque](./images/wt-gen-torque.png) _Fig.4. Generator speed vs
torque._

![WT generator power speed](./images/wt-gen-power-speed.png) _Fig.5. Wind speed
vs turbine speed and power._

There should be kept some safety torque margin (between $$n_1$$ and $$n_2$$ in
Fig.6) due to possible wind gusts.

![Wind curve 1](./images/wind-curve-1.png) _Fig.6. Turbine load torque curve._
