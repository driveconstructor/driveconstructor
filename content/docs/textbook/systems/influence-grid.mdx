...
![Emissions from the drive system](./images/emc_emissions.png)
...
![Waveform of current](./images/fc_input_i.png) _(a)_

![Waveform of voltage](./images/fc_input_u.png) _(b)_

_Fig. 2. Waveforms of current (a) and voltage (b)_.

![Fourier transformation of current](./images/harmonics_c.png) _(a)_

![Fourier transformation of voltage](./images/harmonics_u.png) _(b)_
...
![6-pulse rectifier with a choke system topology](./images/6p_with_choke.png) _(a)_

![Current waveform with THD(i)=28%](./images/THDi28.png) _(b)_
...
![Topology of the 12-pulse system](./images/12p.png) _(a)_

![Current waveform with THD(i)=15%](./images/THDi15.png) _(b)_
...
![AFE converter with LCL filter](./images/fc_with_LCL.png) _(a)_

![Current waveform with THD(i)=5%](./images/THDi5.png) _(b)_
