...
of voltage rise in the IGBT can be up to 5 kV/μs. Influence of the sequence of
pulse fronts with du/dt of 5 kV/μs on the system
...
common mode voltage can take one of the values ±Vdc/2 and ±Vdc/6.
