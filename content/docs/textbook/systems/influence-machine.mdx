...
![Superposition of voltage pulses at the terminals of the machine](./images/reflection.png)
...
![Voltage pulses - leading edge at FC output and machine terminals](./images/impuls_2signals.png) _(a)_

![Voltage pulses - both edges at machine terminals](./images/dudt_pulses.png) _(b)_
...
![du/dt-effect origins](./images/dudt_effect.png) _(a)_

![du/dt-effect consequences](./images/ins_breakdown_E.png) _(b)_
...
![Common-mode voltage](./images/common_mode_voltage.png)
...
![The paths for HF currents](./images/Bearing_currents.png)
