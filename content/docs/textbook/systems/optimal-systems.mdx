...
etc (Fig.2). However, numbers reflecting the components and system behaviour in
...
<img src={qualitative_comparison_1Image.src} width="90%" height="90%" />

_Fig. 2. Qualitative comparison of motor technology_.

import comparing_eff_curvesImage from "./images/comparing_eff_curves.png";

<img src={comparing_eff_curvesImage.src} width="60%" height="60%" /> _Fig. 3.
...
<img src={cost_of_ownershipImage.src} width="60%" height="60%" /> _Fig. 5. Cost
of ownership_.
