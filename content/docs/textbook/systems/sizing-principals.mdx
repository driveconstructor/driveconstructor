...
![Electric machine selection based on mechanical and electrical parameters](./images/longest_circuit_2.png)
_Fig.1_.
...
![Motor-FC-Transformer-Grid connection](./images/mot_fc_trf_grid.png) _Fig. 3_.
...
![Mechanism-Motor connection](./images/mech_mot.png) _Fig. 4_.
...
![Mechanism-Gearbox-Motor connection](./images/mech_gear_mot.png) _Fig. 5_.
...
![Pump curves vs drive curves](./images/pump_curves_vs_drive1.png) _(a)_

![Wind turbine curves vs drive curves](./images/wind_curves_vs_drive3.png) _(b)_

![Conveyor curves vs drive curves](./images/conveyor_curves_vs_drive1.png) _(c)_
