...
A motor controlled by a frequency converter (FC) has become a commodity. This is due to the number of advantages that provide the regulation of the motor speed and, accordingly, the driven mechanism's speed.
The range of applications for variable speed drives (VSD) is very broad: general industry and utilities, defense and aerospace, transport and power generation, household appliances, etc. One of the possible classifications of the applications is presented in Fig. 1.
