...
In *DriveConstructor* it is possible to design systems for the four applications: [pumps](/docs/textbook/applications/pumps), conveyor, winch (or winder) and wind (or tidal) turbine. The applications have different load profiles and operational modes.
