...
- _DFIM_ - Doubly Fed Induction Machine (Fig. 4)

![doc-scim](./images/electric-machines/SCIM.png) _Fig.1A. SCIM_.

![doc-scim-simple1](./images/electric-machines/scim_simple1.png) _Fig.1B. Icon
of SCIM_.

![doc-syrm](./images/electric-machines/SyRM.png) _Fig.2A. SyRM_.

![doc-syrm-simple1](./images/electric-machines/syrm_simple1.png) _Fig.2B. Icon
of SyRM_.

![doc-pmsm-rotor](./images/electric-machines/PMSM_rotor.png) _Fig.3A. Rotor of
PMSM_.

![doc-pm-motor-simple1](./images/electric-machines/pm_motor_simple1.png)
_Fig.3B. Icon of PMSM_.

![doc-dfim-figure-textbook](./images/electric-machines/DFIM_figure_textbook.png)
_Fig.4A. DFIM figure_

![doc-dfim-simple1](./images/electric-machines/DFIM_icon_textbook.png) _Fig.4B. Icon of DFIM_.

SCIM, PMSM and SyRM can be selected for any application and any drive train
topology. DFIM can only be selected for large scale wind/tidal turbine
applications as this is the main usecase for this technology. SyRM are available
for quite limited range of powers. So far only LV SyRM products are known,
therefore only LV FC can be used to drive SyRM.

Performances of the machines of different types are different. Usually:

- Efficiency (SCIM) < Efficiency (SyRM) < Efficiency (DFIM)< Efficiency (PMSM)
- Cost (SCIM) < Cost (SyRM) < Cost (DFIM) < Cost (PMSM)
- Size (DFIM) > Size (SCIM) > Size (SyRM) > Size (PMSM)
...
![doc-em-rated-powers](./images/electric-machines/EM_rated_powers.png)
...
1400, 1600, 2000, 2500, 3150, 4000, 5000, 6000 and 7100.
...
to 10...20 MW (in _DriveConstructor_ up to 7.1 MW), in some cases up to 100 MW!

Slot designs of LV and MV machines look quite different:

![doc-lv-slot](./images/electric-machines/LV_slot.png) _Fig.5. LV slot._

![doc-hv-slot](./images/electric-machines/HV_slot.png) _Fig.6. HV slot._
...
few percent. SyRM and PMSM have rated speed equal rated synchronous speed. DFIM
is able to control the slip actively and thus operate at synchronous speed at nominal power.
...
![doc-efficiency-class1](./images/electric-machines/Efficiency_class1.png)

_Fig.7. Cut-away of standard, energy-efficient, and premium efficiency motors._

Efficiency value for a certain class depends on power as shown on the diagram
below:

![doc-efficiency-class3](./images/electric-machines/Efficiency_class3.png)

_Fig.8. Efficiency classes for 4-pole motors._
...
![doc-cooling1](./images/electric-machines/Cooling1.png) _Fig.9. IC411_.

![doc-cooling2](./images/electric-machines/Cooling2.png) _Fig.10. IC416. Note
separate motor for driving the fan_.

![doc-cooling3](./images/electric-machines/Cooling3.png) _Fig.11. IC71W. Note
the cooling mantle_.

Fig. 12 shows that _IC416_ provides more load capacity at low speeds than
...
![doc-cooling-411-vs-416](./images/electric-machines/cooling_411_vs_416.png)
_Fig.12. IC411 vs IC416_.
...
![doc-em-mounting1](./images/electric-machines/EM_mounting1.png) _Fig.113. B3_

![doc-em-mountingb5](./images/electric-machines/EM_mountingB5.png) _Fig.14. B5_

![doc-em-mountingb35](./images/electric-machines/EM_mountingB35.png) _Fig.15.
B35_
...
![doc-shaft-height](./images/electric-machines/Shaft_height.png) _Fig.16. Shaft
