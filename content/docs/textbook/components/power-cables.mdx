...
#### DFIM cable section modification

The power circuit of a DFIM wind turbine system is devided in two paralell
circuits where one is connectedd to the stator winding and the other is
connected to the rotor windings (Fig. 2). The stator cable is rated for 100% of
the system current, whereas the rotor cable is rated for 30% of the system
current. To account for this, the length of the cable section described in
DriceConstructor will be multiplied by 1.33 when a DFIM system is chosen. This
will enshure that the estimated cost and weight is representative for a DFIM
system as well as for the other machine types.
