...
![doc-basic-fc-2](../images/frequency-converters/basic_fc_2.png) _Fig.1. VSC
topology._
...
![doc-rectification](../images/frequency-converters/rectification.png) _Fig.2.
Rectified current in the DC link._

![doc-pwm-voltage](../images/frequency-converters/pwm_voltage.png) _(a)_

![doc-pwm-current](../images/frequency-converters/pwm_current.png) _(b)_
...
- 4Q FC can transfer power not only from the grid to the machine but also from
  the machine (generator) to the grid. This has to be chosen for a DFIM.
...
4Q FC with fully-controlled inverter scheme at the grid side. Sometimes
...
The FC in a DFIM system is connected to the rotor circuit. DriveConstructor
approximates its rating as 30% of rated machine power, corresponding to the
modeled maximum absolute slip of 30%. A schematic of this system is shown in
Fig. 4.

![doc-dfim-fc-schematic](../images/frequency-converters/DFIM_FC_Schematic.png)
_Fig.4. Frequency converter in DFIM system_.

### Converters of 2-level topology

##### 2Q-2L-VSC-6p, 2Q-2L-VSC-12p and 4Q-2L-VSC

2Q FC inverter scheme at the grid side can be 6-pulse ("6p") and 12-pulse
...
![doc-afe-dc2l-dfe-ing](../images/frequency-converters/afe_dc2l_dfe_Ing.png)
_Fig.5a. 2Q-2L-VSC-6p_.

![doc-afe-dc2l-dfe](../images/frequency-converters/afe_dc2l_dfe.png) _Fig.5b.
Icon designation_.

Note that in Fig.5a the machine side of the FC is the right side, while in
Fig.5b - left side.

![doc-afe-dc2l-dfe12-ing](../images/frequency-converters/afe_dc2l_dfe12_Ing.png)
_Fig.6a. 2Q-2L-VSC-12p_.

![doc-afe-dc2l-dfe12](../images/frequency-converters/afe_dc2l_dfe12.png)
_Fig.6b. Icon designation_.

![doc-afe-dc2l-afe-ing](../images/frequency-converters/afe_dc2l_afe_Ing.png)
_Fig.7a. 4Q-2L-VSC_.

![doc-afe-dc2l-afe](../images/frequency-converters/afe_dc2l_afe.png) _Fig.7b.
Icon designation_.
...
![doc-afe-dc3l-dfe12-ing](../images/frequency-converters/afe_dc3l_dfe12_Ing.png)
_Fig.8a. 2Q-3L-NPC-VSC_.

![doc-afe-dc3l-afe12](../images/frequency-converters/afe_dc3l_afe12.png)
_Fig.8b. Icon designation_.

![doc-afe-dc3l-afe-ing](../images/frequency-converters/afe_dc3l_afe_Ing.png)
_Fig.9a. 4Q-3L-NPC-VSC_.

![doc-afe-dc3l-afe](../images/frequency-converters/afe_dc3l_afe.png) _Fig.9b.
Icon designation_.
...
![doc-schb-2](../images/frequency-converters/SCHB_2.png) _Fig.10a.
2Q-ML-SCHB-VSC topology_.

![doc-schb-dfe-cell](../images/frequency-converters/SCHB_dfe_cell.png) _Fig.10b.
2Q-ML-SCHB-VSC cell_.

![doc-sc-hb-simple2](../images/frequency-converters/sc_hb_simple2.png) _Fig.10c.
Icon designation_.

![doc-schb-afe-cell](../images/frequency-converters/SCHB_afe_cell.png) _Fig.10d.
4Q-ML-SCHB-VSC cell_.

![doc-sc-hb-simple3](../images/frequency-converters/sc_hb_simple3.png) _Fig.10e.
Icon designation_.
...
![doc-fc-lo-ho](../images/frequency-converters/fc_lo_ho.png) _Fig.10. "High
...
Explanation is presented in Fig.11. Note $$I_c$$ which is rated continuous
current, which is not used in practice. Short-term (10 s) high current of up to
200% of $$I_H$$ is acceptable for any converter.

![doc-fc-overloads](../images/frequency-converters/fc_overloads.png) _Fig.11a.
Current overloads of conventional FC_.
...
![doc-fc-cooling-air-nat](../images/frequency-converters/fc_cooling_air_nat.png)
_(a)_

![doc-fc-cooling-air-ac](../images/frequency-converters/fc_cooling_air_AC.png)
_(b)_

![doc-fc-cooling-air-wc](../images/frequency-converters/fc_cooling_air_WC.png)
_(c)_

_Fig.12. Cooling types._
...
![doc-sin-filter-topology](../images/frequency-converters/sin_filter_topology.png)
_(a)_

![doc-sin-filter](../images/frequency-converters/sin_filter.png) _(b)_

_Fig. 13. "Classical" sin-filter topology (a) and product example (b)_.

![doc-pwm-measured](../images/frequency-converters/pwm_measured.png) _(a)_

![doc-after-sin](../images/frequency-converters/after_sin.png) _(b)_

_Fig. 14. The voltage waveforms at the input (a) and at the output (b) of the
...
Structurally, the du/dt filter is a three-phase choke (Fig. 15,a), and from the
...
![doc-dut-filter-topology](../images/frequency-converters/dut_filter_topology.png)
_(a)_

![doc-dut-filter](../images/frequency-converters/dut_filter.png) _(b)_

_Fig. 15. "Classical" du/dt-filter topology (a) and product example (b)_.
...
leading edge of the pulse (Fig.16). The length of the cable is 30 m. Note
different rise time: dt=220 ns, dt=820 ns.

![doc-before-dut](../images/frequency-converters/before_dut.png) _(a)_

![doc-after-dut](../images/frequency-converters/after_dut.png) _(b)_

_Fig. 16. Voltage pulses at the machine terminals without du/dt-filter (a) and
with a filter (b)_.
...
the grid is presented in Fig.17 and 18. The graphs show current waveform and the
value of current distortion THD(i) as % of nominal current at full load.

![doc-6p-no-choke](../images/frequency-converters/6p_no_choke.png) _(a)_

![doc-thdi80](../images/frequency-converters/THDi80.png) _(b)_

_Fig. 17. 6-pulse rectifier without any choke (a) and current waveform for this
topology (b)_.

![doc-6p-with-choke](../images/frequency-converters/6p_with_choke.png) _(a)_

![doc-thdi40](../images/frequency-converters/THDi40.png) _(b)_

![doc-thdi28](../images/frequency-converters/THDi28.png) _(c)_

_Fig. 18. 6-pulse rectifier with a choke (a) and current waveforms for small
choke (b) and big choke (c)_.

##### LCL filter

FC with LCL filter between FC and the grid is presented in Fig.8,a. Current
waveform is very close to sinusoidal as can be seen in Fig. 8,b.

![doc-fc-with-lcl](../images/frequency-converters/fc_with_LCL.png) _(a)_

![doc-thdi5](../images/frequency-converters/THDi5.png) _(b)_

_Fig. 19. Topology (a) and current waveform (b)_.

##### EMC filters

EMC filters (Fig.20) is destined for emission reduction in MHz range. Example of
the effect is presented in Fig.21.

![doc-emc-filter-topology](../images/frequency-converters/emc_filter_topology.png)
_(a)_

![doc-emc-filter-ac](../images/frequency-converters/emc_filter_ac.png) _(b)_

_Fig. 20. EMC filters: topology (a), AC side filter product example (b)_.

![doc-emc-with-without-filter](../images/frequency-converters/EMC_with_without_filter.png)

_Fig. 21. Effect of use of EMC-filter_.
