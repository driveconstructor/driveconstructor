...
Small and ligth FC are usually wall-mounted, while large and heavy are -
...
2Q FC inventor scheme at the grid side can be 6-pusle («6p») and 12-pulse
...
<img src={afe_dc2l_dfe_IngImage.src} width="60%" height="60%" /> _Fig.1a.
2Q-2L-VSC-6p_.

import afe_dc2l_dfeImage from "./images/afe_dc2l_dfe.png";

<img src={afe_dc2l_dfeImage.src} width="20%" height="20%" /> _Fig.1b. Icon
designation_.

Note that on Fig.1a motor side of the FC is the right side, while on Fig.1b -
left side.

import afe_dc2l_dfe12_IngImage from "./images/afe_dc2l_dfe12_Ing.png";

<img src={afe_dc2l_dfe12_IngImage.src} width="90%" height="90%" /> _Fig.2a.
2Q-2L-VSC-12p_.

import afe_dc2l_dfe12Image from "./images/afe_dc2l_dfe12.png";

<img src={afe_dc2l_dfe12Image.src} width="20%" height="20%" /> _Fig.2b. Icon
designation_.

import afe_dc2l_afe_IngImage from "./images/afe_dc2l_afe_Ing.png";

<img src={afe_dc2l_afe_IngImage.src} width="60%" height="60%" /> _Fig.3a.
4Q-2L-VSC_.

import afe_dc2l_afeImage from "./images/afe_dc2l_afe.png";

<img src={afe_dc2l_afeImage.src} width="20%" height="20%" /> _Fig.3b. Icon
designation_.
...
<img src={afe_dc3l_dfe12_IngImage.src} width="90%" height="90%" /> _Fig.4a.
2Q-3L-NPC-VSC_.

import afe_dc3l_afe12Image from "./images/afe_dc3l_afe12.png";

<img src={afe_dc3l_afe12Image.src} width="20%" height="20%" /> _Fig.4b. Icon
designation_.

import afe_dc3l_afe_IngImage from "./images/afe_dc3l_afe_Ing.png";

<img src={afe_dc3l_afe_IngImage.src} width="70%" height="70%" /> _Fig.5a.
4Q-3L-NPC-VSC_.

import afe_dc3l_afeImage from "./images/afe_dc3l_afe.png";

<img src={afe_dc3l_afeImage.src} width="20%" height="20%" /> _Fig.5b. Icon
designation_.
...
<img src={SCHB_2Image.src} width="50%" height="50%" /> _Fig.6a. 2Q-ML-SCHB-VSC
topology_.

import SCHB_dfe_cellImage from "./images/SCHB_dfe_cell.png";

<img src={SCHB_dfe_cellImage.src} width="40%" height="40%" /> _Fig.6b.
2Q-ML-SCHB-VSC cell_.

import sc_hb_simple2Image from "./images/sc_hb_simple2.png";

<img src={sc_hb_simple2Image.src} width="20%" height="20%" /> _Fig.6c. Icon
designation_.

import SCHB_afe_cellImage from "./images/SCHB_afe_cell.png";

<img src={SCHB_afe_cellImage.src} width="40%" height="40%" /> _Fig.6d.
4Q-ML-SCHB-VSC cell_.

import sc_hb_simple3Image from "./images/sc_hb_simple3.png";

<img src={sc_hb_simple3Image.src} width="20%" height="20%" /> _Fig.6e. Icon
designation_.
...
_Fig. 2. The voltage waveforms at the input (a) and at the output (b) of the
...
Structurally, the du/dt filter is a three-phase choke (Fig. 3,a), and from the
...
leading edge of the pulse (Fig.4). The length of the cable is 30 m. Note
...
_Fig. 4. Voltage pulses at the machine terminals without du/dt-filter (a) and
with a filter (b)_.
...
the grid is presented in Fig.5 and 6. The graphs show current waveform and the
value of current distorsion THD(i) as % of nominal current at full load.
...
_Fig. 5. 6-pulse rectifier without any choke (a) and current waveform for this
topology (b)_.
...
_Fig. 6. 6-pulse rectifier with a choke (a) and current waveforms for small
...
EMC filters (Fig.8) is destined for emission reduction in MHz range. Example of
the effect is presented in Fig.9.
