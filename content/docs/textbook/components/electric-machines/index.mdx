...
![doc-dfim-simple1](../images/electric-machines/DFIM_icon_textbook.png) _Fig.4B.
Icon of DFIM_.

SCIM, PMSM and SyRM can be selected for any application and any drive-train
topology. In the current version, DFIM is available only for geared wind-turbine
topologies. SyRM is available for a limited range of powers. So far only LV SyRM
products are known, therefore only LV FC can be used to drive SyRM.
...
few percent. SyRM and PMSM have rated speed equal to rated synchronous speed. A
DFIM controls rotor slip and, in this simplified model, operates from 70% to
130% of synchronous speed.
...
![doc-em-mounting1](../images/electric-machines/EM_mounting1.png) _Fig.13. B3_
