...
collection of factors is presented in tables 1 and 2. In _DriveConstructor_
derating is done automatically when the user sets the right altitude for the
components.

### Power derating

The coefficient of power derating with altitude $$k_h$$ is defined as
...
The coefficient of voltage derating with altitude $$k_v$$ is defined as
