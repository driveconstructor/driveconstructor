...
![EM protection](./images/EM_protection.png)
_Fig.1. Conveyor_.
...
![EM protection table](./images/EM_protection_table.png)
_Fig.2. Examples of IP classes_.
...
![EM protection example](./images/EM_protection_ex.png)
_Fig.3. Open drip proof motor example_.
