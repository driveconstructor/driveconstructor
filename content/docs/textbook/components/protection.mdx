...
<img src={EM_protectionImage.src} width="40%" height="40%" /> _Fig.1. Motor at a conveyor_.[^2]
...
<img src={EM_protection_tableImage.src} width="70%" height="70%" /> _Fig.2. IP classes_.[^1]

In _DriveConstructor_ everything is simplified to only two protection variants: “low” and “high”.
...
<img src={EM_protection_exImage.src} width="30%" height="30%" /> _Fig.3. Open drip proof motor example_.[^3]
...
[^1] [Source missing!](http://www.zkg.de/en/artikel/zkg_2012-05_Resilient_rugged_low-maintenance_1419770.html)
[^2] [Source](http://www.zkg.de/en/artikel/zkg_2012-05_Resilient_rugged_low-maintenance_1419770.html)
[^3] [Source missing!](http://www.zkg.de/en/artikel/zkg_2012-05_Resilient_rugged_low-maintenance_1419770.html)
