...
![Gearbox example](./images/industrial-gearbox-free-image.png)
...
![Helical stage](./images/gear_helical_stage3.png)
_Fig.2. Helical stage_.

![Worm gear](./images/gear_worm3.png)
_Fig.3. Worm gear_.
...
![Worm gear efficiency](./images/worm_helical_eff.png)
_Fig.4. Efficiency of worm gear for different ratios_.
...
![Planetary stage](./images/gear_planetary_stage2.png)
_Fig.5. Planetary stage_.

![Bevel stage](./images/gear_bevel_stage2.png)
_Fig.6. Bevel stage_.
...
![3 helical stages](./images/hel-hel-hel-motor.png)
_Fig.7. Gearbox with 3 helical stages and a motor_.
...
![Bevel and helical stages](./images/bel-3hel.png)
_Fig.8. 1 bevel and 1 helical stage_.

Some more examples are presented in Fig. 9-10.

![Worm and helical for conveyor](./images/worm-hel-conv.png)
_Fig.9. Worm gear and helical stages for conveyor drive_.

![Wind turbine gearbox](./images/wind-turbine-gear-plan-hel-hel.png)
_Fig.10. Gearbox with one planetary and two helical stages for a wind turbine._

![Wind turbine planetary gearbox](./images/plan-plan-plan-hel.png)
_Fig.11. Gearbox with three planetary and one helical stage for a wind turbine_.
...
![Gear efficiencies](./images/gears_effs.png)
_Fig.12. Efficiencies of various combinations_.
